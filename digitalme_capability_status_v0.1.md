...
| **第一纵向闭环** | **`spec_frozen`**；第 1–3 块 **`accepted`**；第 4 块 **`implemented_pending_codex_review`** | 计划 v0.1.7；规格 v0.1.0；`test:vl1-block1/2/3/4` | Experience Proposal → preview → 显式 apply；**下一项（仅登记）** = 正式验收与 Owner 真机验收 |
