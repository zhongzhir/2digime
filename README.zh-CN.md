...
长期方向是：每个 2digime 都可以成为属于真人的智能网络节点；选择权留在你自己的数字之我。当前 Alpha 已有 **最小** 内容闭环（中立目录 → 你自己的兔机米决定是否呈现）。**没有**开放完整内容 Feed 产品、关注 / 订阅网络、交易或支付。
...
内容创作者、媒体、出版机构和平台可通过当前支持的标准公开 RSS / Atom 低成本接入。
Public Alpha 尚未提供自助内容发布 API。
