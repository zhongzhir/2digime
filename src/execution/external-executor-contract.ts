...
export const EXTERNAL_EXECUTOR_MODEL_API_CAPABILITY_ID = 'cap_external_executor_model_api';
export const EXTERNAL_EXECUTOR_MODEL_API_ADAPTER_ID = 'external-executor-model-api';
