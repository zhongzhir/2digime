...
check('用户面文案', toUserFacingLabel('completed'), '尚未决定');
...
check('命令面当前条数', COMMAND_NAMES.length, 23);
check('含 subject.communicate', COMMAND_NAMES.includes('subject.communicate'), true);
